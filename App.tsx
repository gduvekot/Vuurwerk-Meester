    ...
    <div className="relative w-screen h-screen overflow-hidden bg-slate-900 select-none">
      ...
      {gameState === GameState.MENU && (
        <div className="absolute inset-0 flex flex-col items-center justify-center bg-black/60 z-40 backdrop-blur-sm">
          ...
          <h1 onClick={handleTitleClick} className="cursor-pointer text-6xl md:text-8xl font-black text-transparent bg-clip-text bg-gradient-to-br from-red-500 via-yellow-500 to-purple-600 mb-4 drop-shadow-2xl">
            Scalda Spark
          </h1>
